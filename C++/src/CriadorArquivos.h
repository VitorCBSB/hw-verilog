...
public:
	...
	static void cria_arquivo_top_icarus(GeneticParams genetic_params, const Cromossomo& individuo, const std::string& nome_arquivo);
	static void cria_arquivo_data_receiver(GeneticParams genetic_params);
	static void cria_arquivo_sender(GeneticParams genetic_params, int num_samples);
	static void cria_arquivo_main(GeneticParams genetic_params);

private:
	static std::string gera_le_assigns(GeneticParams genetic_params, const Cromossomo& individuo);
	static std::string gera_outs_assigns(GeneticParams genetic_params, const Cromossomo& individuo);
